...
|---|---|---|---|
| [`evidence/F034_CADENCE_IMPACT_ASSESSMENT_2026-09-04.md`](evidence/F034_CADENCE_IMPACT_ASSESSMENT_2026-09-04.md) | Durable evidence | Read-only `F-034` technical impact assessment supporting DFA's DOM-2 ruling; occurrence inventory, design-options assessment, DFA-adjudication flag for evidence-sufficiency; cited directly by `DECISIONS.md`'s DOM-2 entry and `ACTION_PLAN.md` §15r. | — |
