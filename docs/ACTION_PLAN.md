...
**Next SDT increment: SE/PO sequencing decision, not started here.** INC-4/5/6 are not selected or begun by this plan on its own authority — per §1, sequencing is PO's to settle. (INC-12/INC-13, both previously named here, are now closed — see above, not candidates for "next.")
