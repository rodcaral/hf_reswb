...
1. [`ACTION_PLAN.md`](ACTION_PLAN.md) — the master, dependency-ordered coordination plan:
   parties and settled authority (PO/DFA/SE/SDT/UIUX), the three governing sequences, the
   standing prohibitions (SP) and UIUX defaults (UP) increments must cite by ID, the
