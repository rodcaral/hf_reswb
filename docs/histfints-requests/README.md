...
| LINE_BY_LINE_COMPARISON_PACKAGE_2026-08-19.md | Exact runnable SQL + full 56-row intermediate data dump, for direct row-by-row comparison against HistFinTS's rerun | 2026-08-19 | Filed; waiting on HistFinTS's rerun |
